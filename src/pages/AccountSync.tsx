    ...
    <div className="flex flex-col h-full bg-slate-50">
      ...
      <div className="bg-white px-6 pt-6 pb-4 border-b border-slate-100 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900 leading-tight">Cloud Sync</h1>
            <p className="text-xs text-slate-500 font-medium">Safe & Secure Ledger</p>
          </div>
        </div>
      </div>

      {/* Cloud Sync Gated Actions */}
      <PremiumGate featureName="Cloud Sync & Backup">
